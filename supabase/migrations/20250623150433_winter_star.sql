/*
  ...
  1. New Tables
    ...
    - `snippet_versions` - Version control
  ...
  3. Performance
    ...
    - Optimized for collaboration features
*/
...
-- Add search vector column separately to avoid immutable function issues
...
-- Update existing snippets search vector (if any exist)
UPDATE snippets SET search_vector = to_tsvector('english', 
  title || ' ' || 
